...
local creds = window:Tab("检测",'16060333448')

local credis = creds:section("服务器检测",true)

credis:Label("你所在的服务器:"..game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name)


local creds = window:Tab("功能",'16060333448')
